        ...
        <main className="min-h-screen w-full flex items-center justify-center bg-bg-page relative overflow-hidden font-sans selection:bg-accent-primary/30">
            ...
            <div className="relative z-10 w-full max-w-[440px] mx-4">
                <motion.div
                    ...
                    animate="visible"
                >
                    <GlassPanel className="p-8 md:p-12 flex flex-col gap-6 shadow-2xl border-border-subtle/40 backdrop-blur-3xl">

                        {/* Header */}
                        <motion.div variants={itemVariants} className="text-center">
                            <h1 className="text-4xl font-black text-text-primary tracking-tight mb-2">Create Account</h1>
                            <p className="text-text-secondary font-medium text-lg">Start your guitar journey today</p>
                        </motion.div>
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
                            ...
                            <motion.div variants={itemVariants} className="space-y-2">
                                <label className="text-sm font-bold text-text-secondary ml-1">Name (Optional)</label>
                            ...
                            {/* Confirm Password */}
                            <motion.div variants={itemVariants} className="space-y-2">
                                <label className="text-sm font-bold text-text-secondary ml-1">Confirm Password</label>
                                <div className="relative group">
                                    <span className="absolute left-4 top-1/2 -translate-y-1/2 text-text-tertiary group-focus-within:text-accent-primary transition-colors">
                                        <span className="material-symbols-outlined text-[20px]">lock</span>
                                    </span>
                        ...
                        <motion.p variants={itemVariants} className="text-center text-sm text-text-secondary">
                            Already have an account? <Link href="/login" className="font-bold text-accent-primary hover:underline">Log in</Link>
                        </motion.p>
