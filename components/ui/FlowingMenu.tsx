                ...
                <div className="h-full w-fit flex" ref={marqueeInnerRef}>
                    {[...Array(repetitions)].map((_, idx) => (
                        <div className="marquee-part flex items-center flex-shrink-0" key={idx} style={{ color: marqueeTextColor }}>
                            <span className="whitespace-nowrap uppercase font-bold text-[8vh] md:text-[6vh] leading-[1] px-[1vw] tracking-tighter">{text}</span>
                            <div
                                className="w-[150px] md:w-[200px] h-[7vh] my-[2em] mx-[2vw] rounded-[50px] bg-cover bg-center grayscale border border-black/20"
